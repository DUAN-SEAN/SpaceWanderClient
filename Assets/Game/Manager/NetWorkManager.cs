...
namespace Crazy.Main
{
    ...
    public class NetWorkManager:ManagerBase,ITickable
    {
        public NetWorkManager(GameManager gameManager):base(gameManager)
        {
        }
        ...
        public void Tick()
        {
            ...
            {
                m_currentPlayerCtx.Update();
            }
        }
        public  void Initialize(GameServerGlobalConfig config)
        {
        ...
        public void ReleaseSpacePlayerContext()
        {
        ...
        private bool InitNetConfigure(GameServerGlobalConfig config)
        {
            GameServerGlobalConfig gameServerGlobalConfig = config;
    ...
    //{
    //    static PlayerContextHelper()
    //    {
    //        Instance = new PlayerContextHelper();
    //    }
    ...
    //        get
    //        {
    //            if (m_playerContextBase == null)
    //            {
    //                m_playerContextBase = NetWorkManager.Instance.Connect();
                    
    //            }
    //            return m_playerContextBase;
    //        }
    ...
    //        m_playerContextBase = NetWorkManager.Instance.Connect();
    //    }
    //    private PlayerContextBase m_playerContextBase;

    //    public static PlayerContextHelper Instance;

    //    public static ulong CurrentTeamId;
